...
[![golang-migrate](https://img.shields.io/badge/golang--migrate-Migrations-yellow)](https://github.com/pressly/goose)
...
- Database migrations via [goose](https://pressly.github.io/goose/)
- JWT auth
...
- Go 1.20+
- PostgreSQL
- `goose` CLI tool (for running migrations)
